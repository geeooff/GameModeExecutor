...
ticked. Try unticking it and starting the game again: Microsoft may have
listed it since, and then Windows — and this program — recognise it on
their own. [How it works](how-it-works.md#how-it-knows-a-game-is-running)
says why, and what is being done about the games Microsoft does not list.
